    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <a href="{{url('admin/categories/create')}}" class="btn btn-primary mb-2"><i class="fa fa-plus-circle"></i> Add New List</a>
                          ...
                          <tr>
                            ...
                            <td>
                                   <form action="{{url('admin/categories/'.$category->id)}}" method="POST">
                                    @csrf @method('DELETE')
                                    <a href="{{ url('admin/categories/'.$category->id.'/edit')}}" class="btn btn-primary btn-sm rounded-pill">
