        ...
        <div class="row g-0">
            <nav class="col-2 bg-info pe-2 fixed-top mt-2">
                <h1 class="h5 text-dark text-uppercase text-center py-2">
                    ...
                    <span class="d-none d-lg-inline">Golden Land</span>
                </h1>
                <!-- Menu Items -->
            ...
            <main class="col-10 bg-info ms-auto">
                <div class="navbar navbar-expand navbar-light bg-info">
                    <div class="flex-fill bg-info"> 
                        <h6 class="text-center mt-2 text-dark text-uppercase"><strong>Golden Land Admin</strong></h6>
                    </div>
            ...
            <div class="text-center mt-5 ms-5" style="font-size: 18px;"> 
